...
public class BookMarkController {
    ...
    @PostMapping
    public ResponseEntity<?> createBookMark(@AuthenticationPrincipal UserDetails user, @RequestBody UserQuoteRequestDto userQuoteRequestDto){
        System.out.println(userQuoteRequestDto);
        bookMarkService.createBookMark(user, userQuoteRequestDto);
